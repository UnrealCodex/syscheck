...
<div class="col-lg-1 col-centered" style="font-size: 32px" > 
	<form action="diputado_pro.php" method="post">
	<br>
		<div align="center">Resultado final Diputado</div><br>

    <table width="100%" border="1">
      <tbody>
        <tr>
          <td width="50%" align="right">Actuales:</td>
          <td width="50%"><?php echo $_REQUEST['fin_dip']; ?><input type="hidden" value="<?php echo $_REQUEST['fin_dip']; ?>" name="ant_dip"></td>
        </tr>

        <tr>
          <td align="right">Actualizar:</td>
          <td><input type="text" value=""  name="fin_dip" style="width: 120px"></td>
        </tr>
        <tr>
